 ...
 */
public class RoutinesRecycleAdapter extends
    RecyclerView.Adapter<RoutinesRecycleAdapter.ViewHolder> {
...
//    private static final String LOG_TAG = "weekday adapter";
  ...
  public RoutinesRecycleAdapter(List<Routines> _mRoutines, Context context,
...
//    final ImageButton mOptionsButton;
    ...
    final ImageButton routineCompletedButton;
